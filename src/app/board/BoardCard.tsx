...
export default function BoardCard({ num, boardName, boardDesc, boardPos, photo }: BoardCardProps) {
    ...
    <div onMouseEnter={() => {
      ...
      {!isHovering ? <>
        <div className="flex flex-col items-center mt-[-25px] p-parent transition-all duration-300 ">
          ...
          <p className="text-black text-[10px] text-center mx-6 role">{boardPos}</p>
        </div></> :
