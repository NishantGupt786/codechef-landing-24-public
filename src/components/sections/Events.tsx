...
const Component1 = () => {
  ...
  <div className="relative h-3/4 w-5/6 lg:ml-28 xs:ml-8 laptop:ml-24 surface:ml-16 2xl:ml-[210px]">
    <Image
      ...
      width={1310}
      height={512}
      className="xs:mx-auto xs:px-4"
    />
    <div className="absolute inset-0 flex flex-col justify-start items-start xs:items-center xs:text-center xs:px-4">
  ...
  <div className="relative">
    <svg
      className="hidden lg:block absolute left-1/2 transform -translate-x-1/2 w-full h-[2300px] z-0"
      viewBox="0 0 800 2200"
      preserveAspectRatio="xMidYMid meet"
    >
      <path
        ref={pathRef}
        d="M 650, 0 L 650, 100 L 650, 500 L 100, 500 L 100, 1000 L 670, 1000 L 670, 1450 L 100, 1450 L 100, 2000"
        stroke="white"
        strokeWidth="2"
        fill="transparent"
      />
  ...
  <div className="flex mt-20 laptop:ml-10 relative z-10 flex-wrap xs:flex-col xs:items-center xs:mx-4">
    <div className="ml-5 2xl:ml-[400px] xs:text-center xs:ml-0 xs:w-full">
      ...
      <p className="text-white xs:w-36 lg:w-96 lg:ml-14 mt-1 xs:text-3xs lg:text-xl xs:ml-0 xs:text-center">
    ...
    <Image
      ...
      width={500}
      height={500}
      className="xs:w-40 2xl:w-[600px] 2xl:h-[400px] laptop:ml-40 laptop:h-computer laptop:w-computer promax:ml-14 xs:ml-5 lg:ml-56 lg:h-computer lg:w-computer surface:h-56 surface:ml-14 surface:w-72 surface:mt-10 2xl:ml-[500px] xs:mx-auto xs:my-4"
    />
  </div>

  <div className="flex mt-44 2xl:ml-72 2xl:mt-28 laptop:ml-24 relative z-10 flex-wrap xs:flex-col xs:items-center xs:mx-4">
    <Image
      src={people}
      alt="People"
      width={500}
    ...
    />
    <div className="2xl:ml-72 2xl:mt-8 xs:text-center xs:ml-0 xs:w-full">
      ...
      <p className="text-white xs:w-36 lg:w-96 lg:ml-48 mt-1 xs:text-3xs xs:ml-10 lg:text-xl promax:ml-14 surface:ml-40 laptop:ml-56 xs:text-center">
        Events and hackathons are the two cornerstones that make CodeChef-VIT one of the campus' most reputed chapters. Our teamwork, dedication, and determination propel and inspire our events to achieve greater heights.
      </p>
    </div>
  </div>

  <div className="flex mt-44 laptop:ml-10 relative z-10 flex-wrap 2xl:mt-24 xs:flex-col xs:items-center xs:mx-4">
    <div className="ml-5 2xl:ml-[400px] xs:text-center xs:ml-0 xs:w-full">
      <div className="text-white border lg:mt-10 lg:w-48 lg:ml-24 flex xs:w-20 xs:ml-4 justify-center">
        <h1 className="lg:text-3xl xs:text-xs">Cook-Off 9.0</h1>
      </div>
      <p className="text-white xs:w-36 lg:w-96 lg:ml-14 mt-1 xs:text-3xs lg:text-xl xs:text-center">
        CodeChef's Cook-Off 9.0 brings programmers together to showcase their talent and skills. Through this competition, students learn problem-solving, teamwork, and creative thinking.
      </p>
    </div>
    <Image
      src={people}
  ...
  <div className="flex mt-40 2xl:ml-72 2xl:mt-28 laptop:ml-24 relative z-10 flex-wrap xs:flex-col xs:items-center xs:mx-4">
    <Image
      src={people}
      alt="alt"
      width={500}
